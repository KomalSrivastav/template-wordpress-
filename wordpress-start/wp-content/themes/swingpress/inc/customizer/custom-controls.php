 ...
 */
class Swingpress_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Swingpress_Dropdown_Category_Control extends WP_Customize_Control {
...
class Swingpress_Note_Control extends WP_Customize_Control {
...
class Swingpress_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Swingpress_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="swingpress-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Swingpress_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Swingpress_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="swingpress-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="swingpress-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
          <i class="dashicons dashicons-menu swingpress-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="swingpress-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Swingpress_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
	            ...
	            <?php } ?>
	            <input id="swingpress-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'swingpress' ); ?>" class="swingpress-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
...
class Swingpress_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Swingpress_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
