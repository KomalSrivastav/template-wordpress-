...
class Swingpress_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'swingpress';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'swingpress' ), $i ),
...
// Initialize.
$swingpress_footer_widgets = new Swingpress_Footer_Widgets();
